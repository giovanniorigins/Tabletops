...
angular.module('tabletops', ['ionic-material', 'ionic.service.core'/*, 'ionic.service.analytics'*/, 'ionic.service.deploy', 'ionic.service.push', 'underscore', 'GoogleMaps', 'angularMoment', 'ion-affix', 'ionic.rating', 'ionic.resetfield', 'ngResource', 'ngCordova', 'ngCordova.plugins.googleplus', 'LocalForageModule', 'leaflet-directive', 'http-auth-interceptor', 'ionicLazyLoad', 'tabletops.config', 'tabletops.controllers', 'tabletops.directives', 'tabletops.services'])
