...
(function e(t, n, r) {
    ...
    1: [
        function(require, module, exports) {
            ...
            "./src/directions": 6,
            "./src/errors_control": 7,
            "./src/format": 8,
            "./src/input_control": 9,
            "./src/instructions_control": 10,
            "./src/layer": 11,
            "./src/routes_control": 12
        }
    ],
    2: [
        function(require, module, exports) {
            ...
            module.exports = function(container, directions) {
                ...
                directions.on('selectRoute', function(e) {
                    ...
                    steps.append('div')
                        ...
                        .text(function(step) {
                            return step.distance ? format.imperial(step.distance) : '';
                        });
            ...
            module.exports = function(container, directions) {
                ...
                directions.on('load', function(e) {
                    ...
                    routes.append('div')
                        ...
                        .text(function(route) {
                            return format.imperial(route.distance) + ', ' + format.duration(route.duration);
                        });
